(function() {
  const fn = function() {
    ...
    const element = document.getElementById("d4a15fde-f554-4da2-b252-12afd56a6847");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'd4a15fde-f554-4da2-b252-12afd56a6847' but no matching script tag was found.")
        }
