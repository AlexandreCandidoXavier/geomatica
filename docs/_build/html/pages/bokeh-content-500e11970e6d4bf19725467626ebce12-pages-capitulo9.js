(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b33eefbf-daef-4e93-8ab1-0689deb66e91");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b33eefbf-daef-4e93-8ab1-0689deb66e91' but no matching script tag was found.")
        }
