(function() {
  const fn = function() {
    ...
    const element = document.getElementById("cf3bc3d2-9740-4afb-8e57-0ecf6277d76f");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'cf3bc3d2-9740-4afb-8e57-0ecf6277d76f' but no matching script tag was found.")
        }
