(function() {
  const fn = function() {
    ...
    const element = document.getElementById("bfc05aed-85d8-4892-b1e5-06ce3a2501aa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'bfc05aed-85d8-4892-b1e5-06ce3a2501aa' but no matching script tag was found.")
        }
