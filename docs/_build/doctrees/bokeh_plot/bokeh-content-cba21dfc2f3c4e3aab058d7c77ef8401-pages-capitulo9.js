(function() {
  const fn = function() {
    ...
    const element = document.getElementById("b0561fcf-d7c8-45ab-955e-90a46ebbf5fc");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'b0561fcf-d7c8-45ab-955e-90a46ebbf5fc' but no matching script tag was found.")
        }
