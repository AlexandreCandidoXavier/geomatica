(function() {
  const fn = function() {
    ...
    const element = document.getElementById("a44670f0-844a-477f-93d1-9e7891d17ff3");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'a44670f0-844a-477f-93d1-9e7891d17ff3' but no matching script tag was found.")
        }
